/// THIS CODE IS AUTHORED BY DR. JOHN TEMPLETON
///
/// THIS CODE WAS DEMONSTRATED IN DR.TEMPLETON'S SMART HEALTH COURSE AT THE UNIVERSITY OF NOTRE DAME
///
/// UHRAN AND SEXTON DO NOT TAKE CREDIT FOR THIS CODE
...
class _RecordAndPlayScreenState extends State<RecordAndPlayScreen> {
  ...
  _audioControllingSection(String RecordingPath) {
    ...
    return IconButton(
      ...
      icon: Icon(_playProvider.isRecordingPlaying
          ? Icons.pause
